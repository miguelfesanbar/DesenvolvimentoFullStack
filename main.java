...
public class main {
	...
	public static void main(String[] args) {
		...
		LocalDate date1 = LocalDate.of(2010, 3, 10);
		LocalDate date2 = LocalDate.of(2000, 3, 10);
		
		PessoaFisica pf1 = new PessoaFisica(1, "Miguel", "750", 123123, date1, "Masculino");
		System.out.println("Pessoa Física: "+pf1.getNome()+" cadastrada!");
		PessoaJuridica pj1 = new PessoaJuridica(2, "Miguel Inc.", "Goiânia", 000100020003, "Tecnologia");
